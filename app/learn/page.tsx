  ...
  return (
    <main className="learn-shell">
      <header className="learn-header">
        <Link className="brand" href="/" aria-label="Back to plaintext.fun">
      ...
      <div className="learn-main">
        ...
        <p className="learn-lead">
          plaintext.fun turns your message into invisible Unicode characters and places them inside normal-looking generated text. Paste that generated text back into plaintext.fun to recover the hidden message.
        </p>
        ...
        <div className="learn-grid">
          <section className="learn-block">
            <h2>the flow</h2>
            <div>
              <p>The visible text and the hidden message are separate. The local AI writes the visible text; plaintext.fun inserts the hidden data afterwards.</p>
          ...
          <section className="learn-block">
            <h2>reveal</h2>
            <div>
              <p>Paste the full generated text without editing it, then select <strong>Reveal message</strong>. plaintext.fun reads the invisible characters and reconstructs the original message.</p>
            </div>
          </section>
          ...
          <section className="learn-block">
            ...
            <div>
              <ul>
                ...
                <li>WebGPU is used for the local AI when available. If it is unavailable, plaintext.fun uses built-in fallback text and the hide/reveal process still works.</li>
              </ul>
            </div>
          </section>
        </div>
